...
const getAllProductsFromDB = (query) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (query && Object.keys(query).length > 0) {
            products = yield product_model_1.Product.find(query); // Filter products if query is provided
        }
        else {
            products = yield product_model_1.Product.find(); // Fetch all products if no query is provided
        }
        return products;
    }
    catch (error) {
...
const updateProductIntoDB = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    const updatedProductData = __rest(payload, []);
    const result = yield product_model_1.Product.findByIdAndUpdate(id, updatedProductData, {
        new: true,
        runValidators: true,
    });
    return result;
